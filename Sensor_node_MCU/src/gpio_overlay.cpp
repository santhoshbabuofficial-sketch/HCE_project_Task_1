 ...
 * STM32 NUCLEO-G474RE | Zephyr 3.7 | C++20
 */
...
/*
 * Forward declaration (implemented in Part 2/3)
 */
void canRxCallback(
    const device* dev,
    can_frame* frame,
    ...
    std::uint8_t col) noexcept
{
    ...
    lcdCommand(static_cast<std::uint8_t>(0x80U | address));
}
